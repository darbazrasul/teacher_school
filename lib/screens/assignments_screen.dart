  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: listTile(
                  ...
                  date: 'date$index',
                  onEditTap: () {
                    Navigator.of(context).pushNamed('/editAssignmentScreen');
                  },
                  onDeleteTap: () {},
                ),
              );
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          //TODO add assinment
          print('add assignment is pressed');
          Navigator.of(context).pushNamed('/createAssignmentScreen');
        },
        backgroundColor: AppColors.primaryColor,
        child: Icon(
          Icons.add,
